...
export default function Page() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
        <header className="w-full bg-blue-200 overflow-hidden flex md:h-[30%] shrink-0 items-center  border-b ">
          <div className=" ">
            <div className="absolute top-0 left-0 w-full p-7 h-[15%] md:h-[30%] bg-black sm:h-[14%] bg-opacity-65">
              <div className=" flex items-center gap-5 mb-4 text-white font-bold">
              ...
              <div className="h-full  text-white md:w-[80%] lg:w-[51%]">
                <h1 className="mb-2 md:mb-2 lg:mb-4 text-lg md:text-xl font-medium">
        ...
        <header className="w-full  overflow-hidden flex p-2 items-center  border-b ">
          <Button variant="themeMatch" className="text">
            All Events
          </Button>
          <Button variant="themeMatch" className="text">
            Saved Events (2)
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="grid auto-rows-min gap-4 md:grid-cols-3">
            <h1 className="text-lg font-semibold">Feature Events</h1>
